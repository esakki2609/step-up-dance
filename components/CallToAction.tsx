      ...
      <div className="relative z-10 py-20 px-6 md:py-24 lg:py-28 text-center max-w-[800px] mx-auto flex flex-col items-center">
        ...
        >
          ...
          <div className="bg-[#111] border border-[#c9a84c30] rounded-[16px] p-8 md:p-10 mb-10 text-left md:text-center shadow-xl">
            ...
            <p className="text-[#C9A84C] text-[18px] font-bold tracking-[1px] mb-6">
              📞 +91 99521 62600
            </p>

            {/* Social Icons */}
            <div className="flex justify-center md:justify-center justify-start items-center gap-5 mt-4 pt-6 border-t border-[#c9a84c20]">
              <a 
                href="https://www.instagram.com/stepup.dancer?utm_source=qr" 
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-11 h-11 rounded-full bg-[#1A1A1A] text-[#888] hover:text-white hover:bg-gradient-to-tr hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#F56040] transition-all hover:scale-110 shadow-lg border border-[#333] hover:border-transparent"
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-11 h-11 rounded-full bg-[#1A1A1A] text-[#888] hover:text-white hover:bg-[#FF0000] transition-all hover:scale-110 shadow-lg border border-[#333] hover:border-transparent"
                aria-label="YouTube"
              >
