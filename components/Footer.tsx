      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/stepup.dancer?utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-[#888] hover:text-[#C9A84C] transition-colors">
            ...
            <a href="https://youtube.com/@9952162600?si=CU6Qiml6vh0bITEi" target="_blank" rel="noopener noreferrer" className="text-[#888] hover:text-[#C9A84C] transition-colors">
